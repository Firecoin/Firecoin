...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 5909 or testnet: 15909)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 5908 or testnet: 15908)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Firecoin Wiki for SSL setup instructions)") + "\n" +
